...
// 所有的unit
	...
	[Message(InnerOpcode.R2G_PlayerOnline_Res)]
	public partial class R2G_PlayerOnline_Res: IResponse
	{
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.R2G_PlayerOffline_Res)]
	public partial class R2G_PlayerOffline_Res: IResponse
	{
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2R_PlayerKickOut_Res)]
	public partial class G2R_PlayerKickOut_Res: IResponse
	{
		public int RpcId { get; set; }
...
//创建房间请求
	[Message(InnerOpcode.G2G_CreateRoom_Req)]
	public partial class G2G_CreateRoom_Req: IRequest
	{
		public int RpcId { get; set; }

	}

	[Message(InnerOpcode.G2G_CreateRoom_Res)]
	public partial class G2G_CreateRoom_Res: IResponse
	{
		public int RpcId { get; set; }
...
//断线保存数据
	[Message(InnerOpcode.G2G_QuitSave_Req)]
	public partial class G2G_QuitSave_Req: IRequest
	{
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2G_QuitSave_Res)]
	public partial class G2G_QuitSave_Res: IResponse
	{
		public int RpcId { get; set; }
...
//请求设置游戏返奖率
	[Message(InnerOpcode.G2G_SetRoomRewardRate_Req)]
	public partial class G2G_SetRoomRewardRate_Req: IRequest
	{
		public int RpcId { get; set; }
...
//设置游戏返奖响应
	[Message(InnerOpcode.G2G_SetRoomRewardRate_Res)]
	public partial class G2G_SetRoomRewardRate_Res: IResponse
	{
		public int RpcId { get; set; }
