namespace ETModel
{
	public static partial class InnerOpcode
	{
		 ...
		 public const ushort R2G_PlayerOnline_Res = 1035;
		 public const ushort G2R_PlayerOffline_Req = 1036;
		 public const ushort R2G_PlayerOffline_Res = 1037;
		 public const ushort R2G_PlayerKickOut_Req = 1038;
		 public const ushort G2R_PlayerKickOut_Res = 1039;
		 public const ushort G2G_CreateRoom_Req = 1040;
		 public const ushort G2G_CreateRoom_Res = 1041;
		 public const ushort G2G_QuitSave_Req = 1042;
		 public const ushort G2G_QuitSave_Res = 1043;
		 public const ushort G2G_SetRoomRewardRate_Req = 1044;
		 public const ushort G2G_SetRoomRewardRate_Res = 1045;
	}
}
