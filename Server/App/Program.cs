			...
			{			
				...
				switch (startConfig.AppType)
				{
					...
					case AppType.AllServer:
                        ...
                        Game.Scene.AddComponent<PokerGateSessionKeyCpt>();
                        Game.Scene.AddComponent<PlayerManagerComponent>();
                        Game.Scene.AddComponent<OnlineComponent>();
                        Game.Scene.AddComponent<LobbyManagerCpt>();
                        Game.Scene.AddComponent<DataBaseSaveComponet>();
                        Game.Scene.AddComponent<RankingManagerCpt>();
                        Game.Scene.AddComponent<PingComponent,int,long>(180000,300000);
                        Game.Scene.AddComponent<ScrollToNoticeComponent>();
