...
public class BMFont
{
    ...
    [HideInInspector][SerializeField] string mName;             // 字体名字
    [HideInInspector][SerializeField] int mFontSize;            // 字体大小
    ...
    public string fontName { get { return mName; } set { mName = value; } }
