...
namespace ETEditor
{
	...
	public class BuildEditor : EditorWindow
	{
		...
		private void OnGUI() 
		{
            ...
            version = EditorGUILayout.TextField("当前资源版本号:", Application.version);
            if (GUILayout.Button("开始打包"))
			{
				...
				BuildHelper.Build(this.platformType, this.buildAssetBundleOptions, this.buildOptions, this.isBuildExe, this.isContainAB, version);
			}
		}
