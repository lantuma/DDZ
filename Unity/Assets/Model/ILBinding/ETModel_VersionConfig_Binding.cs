...
{
    unsafe class ETModel_VersionConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ETModel.VersionConfig);
        ...
        {
            return ((ETModel.VersionConfig)o).Version;
        }
        static void set_Version_0(ref object o, object v)
        {
            ((ETModel.VersionConfig)o).Version = (System.Int32)v;
        }
