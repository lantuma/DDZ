...
{
    unsafe class ETModel_SubGameFactory_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.SubGameFactory);
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Int64 @GameID = *(long*)&ptr_of_this_method->Value;


            var result_of_this_method = ETModel.SubGameFactory.Create(@GameID, @Index);
