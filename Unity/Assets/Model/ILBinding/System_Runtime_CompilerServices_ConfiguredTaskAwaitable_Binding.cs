...
{
    unsafe class System_Runtime_CompilerServices_ConfiguredTaskAwaitable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Runtime.CompilerServices.ConfiguredTaskAwaitable);
            args = new Type[]{};
            method = type.GetMethod("GetAwaiter", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetAwaiter_0);

            app.RegisterCLRCreateDefaultInstance(type, () => new System.Runtime.CompilerServices.ConfiguredTaskAwaitable());
