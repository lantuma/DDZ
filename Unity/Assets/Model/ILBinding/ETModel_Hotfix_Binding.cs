...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Hotfix_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            field = type.GetField("OnApplicationResume", flag);
            app.RegisterCLRFieldGetter(field, get_OnApplicationResume_3);
            app.RegisterCLRFieldSetter(field, set_OnApplicationResume_3);
        ...
        static object get_OnApplicationResume_3(ref object o)
        {
            return ((ETModel.Hotfix)o).OnApplicationResume;
        }
        static void set_OnApplicationResume_3(ref object o, object v)
        {
            ((ETModel.Hotfix)o).OnApplicationResume = (System.Action)v;
        }
        ...
        {
            ((ETModel.Hotfix)o).OnApplicationPause = (System.Action)v;
        }
