...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Component_Binding
    {
            ...
            if (genericMethods.TryGetValue("GetComponentsInParent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UnityEngine.Canvas[])))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, GetComponentsInParent_1);
        ...
        static StackObject* GetComponentsInParent_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.GetComponentsInParent<UnityEngine.Canvas>();
