...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_PointerEventData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_pointerPressRaycast_0);
            args = new Type[]{};
        ...
        static StackObject* get_pointerPressRaycast_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
