...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ClientComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_webConfig", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_webConfig_1);
        ...
        static StackObject* get_webConfig_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            ...
            var result_of_this_method = instance_of_this_method.webConfig;
