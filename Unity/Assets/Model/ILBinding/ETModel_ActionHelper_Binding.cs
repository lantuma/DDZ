...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ActionHelper_Binding
    {
        ...
        static StackObject* Add_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.UI.Slider.SliderEvent @SliderValueChangedEvent = (UnityEngine.UI.Slider.SliderEvent)typeof(UnityEngine.UI.Slider.SliderEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            ETModel.ActionHelper.Add(@SliderValueChangedEvent, @action);
