    ...
    unsafe class System_Threading_Tasks_Task_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("FromResult", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(System.Threading.Tasks.Task<System.String>), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, FromResult_2);
            ...
            method = type.GetMethod("ConfigureAwait", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ConfigureAwait_3);
        ...
        static StackObject* FromResult_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = System.Threading.Tasks.Task.FromResult<System.String>(@result);
