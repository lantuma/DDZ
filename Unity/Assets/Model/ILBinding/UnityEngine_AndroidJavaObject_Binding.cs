    ...
    unsafe class UnityEngine_AndroidJavaObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UnityEngine.AndroidJavaObject), typeof(System.String), typeof(System.Object[])))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            method = methods.Where(t => t.Name.Equals("Call") && t.CheckMethodParams(args)).Single();
            ...
            if (genericMethods.TryGetValue("Call", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Int32), typeof(System.String), typeof(System.Object[])))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Get_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Get<UnityEngine.AndroidJavaObject>(@fieldName);
        ...
        static StackObject* Call_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.Call<System.Int32>(@methodName, @args);
