    ...
    public sealed class TChannel : AChannel
    {
        ...
        private void OnRecvComplete(object o)
        {
            ...
            while (true)
            {
                ...
                {
                    Log.Error(ee + myDebugInfo(this.socket));
        ...
        /**
         * getDebugInfo: trueboy
         */
        public String myDebugInfo(Socket socket)
        {
            if (socket == null)
            {
                return "[MyDebug - socket == null]\n\n";
            }
            else if (socket.RemoteEndPoint == null)
            {
                return "[MyDebug - socket.RemoteEndPoint == null]\n\n";
            }
            else
            {
                return "[MyDebug - socket.RemoteEndPoint: " + socket.RemoteEndPoint.ToString()
                        + ", TChannel.RemoteAddress.Address: " + this.RemoteAddress.Address.ToString() + "]\n\n";
            }
        }
